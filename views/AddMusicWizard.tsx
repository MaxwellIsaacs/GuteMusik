...
export const AddMusicWizard: React.FC<AddMusicWizardProps> = ({ playlist, isLinux, onClose, onToast }) => {
  ...
  return (
    <div
      className={`absolute inset-0 z-[100] flex flex-col ${isLinux ? 'bg-black/95' : 'bg-black/90 backdrop-blur-2xl'}`}
