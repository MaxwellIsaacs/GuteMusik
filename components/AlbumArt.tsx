  ...
  return (
    <div className="relative w-full h-full">
      ...
      {isFallback && !showPopup && (
        <div
          className="absolute bottom-1 right-1 w-2 h-2 bg-amber-500 rounded-full shadow-lg animate-pulse"
      ...
      {showPopup && (
        <div
          className="absolute inset-0 bg-black/80 backdrop-blur-sm flex flex-col items-center justify-center p-3 z-10 animate-in fade-in duration-200"
